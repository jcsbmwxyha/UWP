...
EventProvider = {
	...
	queue = {
		...
		["1"] = { Effect = "Breath" , Viewport = "All" , Trigger = "OneTime" , Delay = 0 , Duration = -1 },
		--["2"] = { Effect = "Breath" , Viewport = "Centor" , Trigger = "Period" , Delay = 3000 , Duration = 3000 },
		--["3"] = { Effect = "Breath" , Viewport = "Right" , Trigger = "Period" , Delay = 6000 , Duration = 3000 },
		--["3"] = { Effect = "Breath" , Viewport = "Right" , Trigger = "Period" , Delay = 6000 , Duration = 3000 },
		--["2"] = { Effect = "Rainbow" , Viewport = "Centor" , Trigger = "Period" , Delay = 3000 , Duration = 3000 },
		--["3"] = { Effect = "Comet" , Viewport = "Right" , Trigger = "Period" , Delay = 6000 , Duration = 3000 },
		--["2"] = { Effect = "Ripple" , Viewport = "Centor" , Trigger = "KeyboardInput" , Delay = 3000 , Duration = 3000 },
		--["1"] = { Effect = "Breath" , Viewport = "Left" , Trigger = "Period" , Delay = 0 , Duration = 3000 },
	},

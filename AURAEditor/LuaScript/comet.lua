...
EventProvider = {
	...
	name = "I am Comet Sample Script",

	period = 5000,

	queue = {

		["1"] = { Effect = "Comet" , Viewport = "All" , Trigger = "Period" , Delay = 0 , Duration = 5000 },
		--["2"] = { Effect = "Static" , Viewport = "All" , Trigger = "OneTime" , Delay = 0 , Duration = -1 },
...
Event = {
	...
	Rainbow = {
		...
		wave = { waveType = "QuarterSineWave" , min = 0 , max = 1 , waveLength = 42, 
	...
	Comet = {
		...
		wave = { waveType = "TriangleWave" , min = 0 , max = 1 , waveLength = 2, 
				freq = 0.02, phase = 0.0, start = -10 , velocity = 8 },
